...
import { CircleDollarSign, CircleDollarSignIcon, ShoppingBagIcon, ShoppingBasketIcon, StarIcon, TagsIcon } from "lucide-react"
            ...
            <div className="flex flex-wrap  gap-5 my-10 mt-4">
                {
                    dashboardCardsData.map((card, index) => (
                        <div key={index} className="border border-slate-200 flex items-center gap-11 p-3 px-6 rounded-lg">
            ...
            <div>
                {
                    dashboardData.ratings.map((review,index)=>(
                        <div key={index} className="flex max-sm:flex-col gap-5 sm:items-center justify-between py-6 border-b border-slate-200 text-sm text-slate-400 max-w-4xl">
                           <div>
